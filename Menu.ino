...
switch(opsi){
  ...
  case 5:
  lcd2.setCursor(16,1);lcd2.print("Set");
  lcd2.setCursor(14,2);lcd2.print("Sprayer");
  lcd2.setCursor(1,0);lcd2.print("Day    : ");lcd2.print(set_day);
  lcd2.setCursor(1,1);lcd2.print("hour   : ");lcd2.print(set_hour);
  lcd2.setCursor(1,2);lcd2.print("minute : ");lcd2.print(set_minute);
  lcd2.setCursor(1,3);lcd2.print(jam);lcd2.print(":");lcd2.print(menit);lcd2.print(":");lcd2.print(detik);lcd2.print(" ");
